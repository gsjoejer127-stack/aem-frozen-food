...
export const DICTIONARY = {
  en: {
    ...
    deliveryKlangDesc: 'Enjoy FREE cold-truck shipping for orders RM1000 and above. Under RM1000, a flat cold-chain delivery fee of RM40 applies.',
    deliveryOutTitle: 'Outstation States (West Malaysia)',
    deliveryOutDesc: 'We ship to all major cities in Peninsular Malaysia. FREE cold-chain delivery for orders RM1500 and above. Under RM1500, a flat delivery fee of RM40 applies.',
    ...
    salesDisclaimer: 'Sales operating period: Monday to Saturday. Note: This website is generated by AI. Therefore, if there are any issues, we will use our sales as the standard.'
  },
  zh: {
    // Nav
    home: '首页',
    ...
    deliveryKlangDesc: '订单满 RM1000 即可享受免费冷链专车送货。低于 RM1000 统一收取 RM40 冷链运费。',
    deliveryOutTitle: '外州区域 (西马半岛其他各州)',
    deliveryOutDesc: '我们配送至西马半岛各主要城市。订单满 RM1500 即可享受免运费冷链配送，低于 RM1500 统一收取 RM40 冷链运费。',
    ...
    salesDisclaimer: '销售服务时间：周一至周六。注：本网站由 AI 生成。因此，如有任何疑问或问题，一切以我们销售团队的答复为准。'
  },
  ms: {
    // Nav
    home: 'Utama',
    ...
    deliveryKlangDesc: 'Nikmati penghantaran lori sejuk BEBAS caj untuk pesanan RM1000 ke atas. Bagi pesanan bawah RM1000, caj tetap RM40 dikenakan.',
    deliveryOutTitle: 'Kawasan Luar Negeri (Semenanjung)',
    deliveryOutDesc: 'Kami menghantar ke semua bandar utama di Semenanjung Malaysia. Penghantaran lori sejuk BEBAS caj untuk pesanan RM1500 ke atas. Bagi pesanan bawah RM1500, caj RM40 dikenakan.',
    ...
    salesDisclaimer: 'Waktu operasi jualan: Isnin hingga Sabtu. Nota: Laman web ini dijana oleh AI. Oleh itu, jika terdapat sebarang isu, maklumat daripada pihak jualan kami adalah sebagai rujukan muktamad.'
  }
};
